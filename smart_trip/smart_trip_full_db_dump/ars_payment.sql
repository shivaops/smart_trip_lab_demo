...
CREATE TABLE `payment` (
  ...
  KEY `idx_payment_booking` (`booking_reference`,`payment_date`),
  CONSTRAINT `fk_payment_booking` FOREIGN KEY (`booking_reference`) REFERENCES `booking` (`booking_reference`) ON DELETE CASCADE
